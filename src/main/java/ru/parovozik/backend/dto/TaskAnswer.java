...
public record TaskAnswer(String title, String body, Status status, Privacy privacy, Color color, LocalDateTime starting, LocalDateTime ending, PushTemplate pushTemplate) {
}
